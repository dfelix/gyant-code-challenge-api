...
const [...data] = fs.readFileSync('conditions.csv').toString().split('\n');
...
// Connection URL
const url = 'mongodb://root:password@localhost:27017/gyant?authSource=admin';
...
MongoClient.connect(url, async function (err, client) {
  ...
  await client
    ...
    .insertMany([
      {
        email: 'ghouse@gyant.com',
        password: await bcrypt.hash('ghouse@gyant.com', 10),
        name: 'Gregory House',
      },
      {
        email: 'jdorian@gyant.com',
        password: await bcrypt.hash('jdorian@gyant.com', 10),
        name: 'John Dorian',
      },
      {
        email: 'cyang@gyant.com',
        password: await bcrypt.hash('cyang@gyant.com', 10),
        name: 'Cristina Yang',
      },
    ]);
